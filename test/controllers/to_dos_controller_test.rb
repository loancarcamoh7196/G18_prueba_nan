...
class ToDosControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create to_do" do
    assert_difference('ToDo.count') do
      post to_dos_url, params: { to_do: { description: @to_do.description, image: @to_do.image, name: @to_do.name } }
    end
  ...
  test "should update to_do" do
    patch to_do_url(@to_do), params: { to_do: { description: @to_do.description, image: @to_do.image, name: @to_do.name } }
